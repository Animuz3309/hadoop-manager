...
function _containerUrl(container) {
  return `/api/containers/${container.id}`;
}
...
export function create(container) {
  return {
    ...
    promise: (client) => client.post(`/api/containers/create`, {data: container})
  };
}
...
export function loadDetailsByName(clusterName, containerName) {
  return {
    ...
    promise: (client) => client.get(`/api/containers/${clusterName}/${containerName}`)
  };
}
...
export function recreate(container) {
  ...
  return {
    ...
    id: container.id,
    promise: (client) => client.post(`/api/containers/recreate`, {params: {container: container.id}})
  };
}
